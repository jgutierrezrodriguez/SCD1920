...
public class Main {
    ...
    // Constantes
    public static final int INICIALIZACION = 1;
    ...
    public static enum ElementoResultado {MAYOR, APARICIONES_MAYOR, MENOR, APARICIONES_MENOR}
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        Tarea tarea = new Tarea(datos,INICIO_DATOS,INICIO_DATOS,NUM_ELEMENTOS);
