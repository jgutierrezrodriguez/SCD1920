...
public interface Constantes {
    ...
    public static final int SISTEMA = 6;
    public static final int INSTALADORES = 4;
    public static final int FABRICANTES = 4;
    ...
    public static final int INSTALACION = 3; // segundos
    public static final int FABRICACION = 4; // segundos
    public static final int ESPERA_INSTALADOR = 2; // segundos
}