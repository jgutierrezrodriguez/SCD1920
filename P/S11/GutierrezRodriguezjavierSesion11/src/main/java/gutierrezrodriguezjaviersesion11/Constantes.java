...
public interface Constantes {
    ...
    public enum TipoSensor {
        ...
        /**
         * Simula un tiempo para la fabricación de un sensor
         * @return 
         *      el tiempo de fabricación del sensor
         */
        public static int tiempoFabricacion() {
            return aleatorio.nextInt(VARIACION);
        }
    }
    ...
    public static final int NUM_CASAS = 4;
    
    // Conexión Broker
    public static final String QUEUE = "uja.ssccdd.sesion11.jgr00053";
