...
public interface Constantes {
    ...
    public static final int TOTAL_INSTALADORES = 10;
    ...
    public static final int TIEMPO_ESPERA = 20; // segundos
    public static final int VARIACION = 3; // Diferencia en habitaciones
    public static final int NUM_SENSORES = 5;
    public static final int NUM_CASAS = 3;
}